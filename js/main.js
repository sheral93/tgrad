$(document).ready(function() {
    ...
    $('#show-hide-password-2 a').on('click', function(event) {
        event.preventDefault();
        if ($('#show-hide-password-2 input').attr('type') == 'text') {
            $('#show-hide-password-2 input').attr('type', 'password');
            $('#show-hide-password-2 i').addClass('fa-eye-slash');
            $('#show-hide-password-2 i').removeClass('fa-eye');
        } else if ($('#show-hide-password-2 input').attr('type') == 'password') {
            $('#show-hide-password-2 input').attr('type', 'text');
            $('#show-hide-password-2 i').removeClass('fa-eye-slash');
            $('#show-hide-password-2 i').addClass('fa-eye');
        }
    });
